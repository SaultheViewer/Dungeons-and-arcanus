...
public record PCPotFeatureConfig(FloatProvider mimicChance) implements FeatureConfiguration {
   public static final Codec<PCPotFeatureConfig> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(FloatProvider.CODEC.fieldOf("rarity").forGetter(PCPotFeatureConfig::mimicChance))
